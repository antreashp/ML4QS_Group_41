...
DATASET_FNAME = sys.argv[1] if len(sys.argv) > 1 else 'own_data_chapter2_result.csv'
RESULT_FNAME = sys.argv[2] if len(sys.argv) > 2 else 'own_data_chapter3_result_outliers.csv'
...
DATA_PATH = Path('./intermediate_datafiles/')
DATASET_FNAME = 'own_data_chapter5_result.csv'
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'acc_phone_x', '2020-06-05 13:11:27',
#                                                                                   '2016-02-08 18:29:58','2016-02-08 18:29:59')
                                                                                   '2020-06-05 13:43:26', '2020-06-05 13:55:40')
...
basic_features = ['acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z',
                  'labelelevator','labelonTable','labelstanding','labelwalking',
                  'light_phone_lux','mag_phone_x','mag_phone_y','mag_phone_z','press_phone_pressure', 'prox_phone_distance']
...
selected_features = ["gyr_phone_y_freq_0.9_Hz_ws_40", "pca_3", "pca_3_temp_mean_ws_120", "pca_4_temp_mean_ws_120",
                     "acc_phone_z_freq_0.9_Hz_ws_40", "pca_5", "pca_4", "acc_phone_y_freq_0.9_Hz_ws_40",
                     "gyr_phone_z_freq_0.5_Hz_ws_40", "gyr_phone_x_freq_0.1_Hz_ws_40"]
...
regr_train_y, regr_test_y = learner.recurrent_neural_network(train_X[selected_features], train_y, test_X[basic_features], test_y, gridsearch=True)
DataViz.plot_numerical_prediction_versus_real(train_X.index, train_y, regr_train_y['acc_phone_x'], test_X.index, test_y, regr_test_y['acc_phone_x'], 'acc_phone_x')
